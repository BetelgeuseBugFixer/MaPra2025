...
from models.foldtoken_decoder.src import constants
from models.foldtoken_decoder.src.layers import graph
from models.foldtoken_decoder.src.layers.structure import protein_graph
from models.foldtoken_decoder.src.layers.structure.geometry import (
    dihedrals,
    extend_atoms,
