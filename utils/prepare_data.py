...
--------------------------------
Speicheroptimierte Version des ursprünglichen prepare_data‑Skripts.
...
from models.bio2token.data.utils.utils import (
    pdb_2_dict,
    uniform_dataframe,
    compute_masks,
)
...
CHUNK_SIZE = 1_000         # Fortschritts‑Intervall
...
model_cfg_yaml = load_from_yaml("models/bio2token/files/model.yaml")["model"]
model_config = pi_instantiate(AutoencoderConfig, model_cfg_yaml)
