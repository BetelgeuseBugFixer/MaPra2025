...
def get_T5_model(model_dir: Path, transformer_link: str):
    """
    Load only the T5 encoder models and slow tokenizer from HuggingFace,
    ...
    if device.type == "cuda":
        try:
            ...
            logging.info("Compiled models with torch.compile() for additional speed.")
...
def create_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help='Identifier of the ProtT5 encoder models.'
    )
    parser.add_argument(
